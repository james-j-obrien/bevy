...
use crate::{
    self as bevy_ecs,
    component::{Component, ComponentIdFor, Tick},
    entity::Entity,
...
pub struct RemovedComponentEvents {
    event_sets: SparseSet<Entity, Events<RemovedComponentEntity>>,
}
...
impl RemovedComponentEvents {
    ...
    pub fn get(&self, component_id: impl Into<Entity>) -> Option<&Events<RemovedComponentEntity>> {
        self.event_sets.get(component_id.into())
    }

    /// Sends a removal event for the specified component.
    pub fn send(&mut self, component_id: impl Into<Entity>, entity: Entity) {
        self.event_sets
